...
$(document).ready(function() {
    ...
    $("#password_change").submit(function (e) {
        ...
        if(pass == confirm_pass){
            ...
            $("#confirm_new_password").css('border-color', 'green');
        }
        else {
...
function checkEmail(obj){
    ...
    {
        $('#usernameError').empty();    
        $("#usernameError").append("Enter valid Email");
...
function checkEmailPassworReset(obj){
    var userName = $(obj).val();   
    console.log(userName);     
    var pattern = /^\b[A-Z0-9._%-]+@[A-Z0-9.-]+\.[A-Z]{2,4}\b$/i ;
    if(!pattern.test(userName))
    {
        $("#is_email_exist").val(1);
        $('#emailError').empty();    
        $("#emailError").append("Enter valid Email");
        $(obj).css('border-color', 'red');
        $("#emailError").css('color', 'red');
        $("#emailError").css('font-size', '12px');
        $("#emailError").css('padding', '4px'); 
    }
    else {              
        var request = $.ajax({
            url: "userDetails.cfm",
            ...
            success: function(data) {                                        
                if(data.STAT == 1) {                    
                    ...
                    $("#is_email_exist").val(0);
                    $('#emailError').empty();
                    $("#emailError").append("Email Doesn't Exist!");
                    $(obj).css('border-color', 'red');
                    $("#emailError").css('color', 'red');
                    $("#emailError").css('font-size', '12px');
                    $("#emailError").css('padding', '4px');   
...
function confirmPassword(){
    ...
    var confirm_pass = $("#confirm_pass").val();
    if(pass == confirm_pass){
        $("#pass").css('cssText', 'border-color: green !important');
        $("#confirm_pass").css('cssText', 'border-color: green !important');
    }
    else {
        $("#pass").css('cssText', 'border-color: red !important');
        $("#confirm_pass").css('cssText', 'border-color: red !important');
    }
}
